...
X_train_pd.to_csv('X_train',index=False)
y_train_pd.to_csv('y_train',index=False)
X_val_pd.to_csv('X_val',index=False)
y_val_pd.to_csv('y_val',index=False)
X_test_pd.to_csv('X_test',index=False)
y_test_pd.to_csv('y_test',index=False)
